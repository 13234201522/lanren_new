    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <select id="c-pid" data-rule="required" class="form-control selectpicker" name="row[pid]">
                <?php if(is_array($pid_list) || $pid_list instanceof \think\Collection || $pid_list instanceof \think\Paginator): if( count($pid_list)==0 ) : echo "" ;else: foreach($pid_list as $key=>$vo): ?>
